...
\resumeHeadingListStart
  ...
  \resumeExpHeading{Faculty Member --- Institute for Advanced Study, Princeton}{1933 -- 1955}
  \resumeItemListStart
      \resumeItem{Pursued unified field theory as one of the Institute's first faculty members, serving from his 1933 appointment until his death in 1955.}
      \resumeItem{Advanced research across gravitation, quantum theory, and statistical physics through papers, lectures, and correspondence with international scientists.}
      \resumeItem{Communicated complex technical ideas through academic publications, public-facing writing, and invited lectures.}
  \resumeItemListEnd
  ...
  \resumeItemListStart
      ...
      \resumeItem{Published foundational work on gravitation, cosmology, quantum theory, and statistical mechanics while based in Berlin.}
  \resumeItemListEnd
...
\begin{itemize}[leftmargin=0.2em, labelsep=0pt, label={}, itemsep=0pt, parsep=0pt, topsep=1pt]
    ...
    \item \small \textbf{Languages:} German, English, French
\end{itemize}
...
\resumeHeadingListStart
  \resumeHeading
    ...
    {Zurich, Switzerland}
    {Ph.D. in Physics; thesis submitted in 1905 and degree conferred in 1906}
    {1905 -- 1906}
  \resumeHeading
    {Swiss Federal Polytechnic}
    {Zurich, Switzerland}
    {Diploma, School for Subject Teachers in Mathematics and Physics}
    {1896 -- 1900}
\resumeHeadingListEnd
